...
// Leader Section: send heart beat to keep followers alive
...
// leader send append log to follower
...
// AppendEntries RPC handler.处理心跳和日志复制,更新日志和提交索引。
...
// If election timeout elapses: start new election handled in caller 发起一轮选举,向其他节点请求投票。
...
// 处理客户端请求,replicate log 如果是leader。
